...
<div class="main-body">
	<div class="main-container">
		...
		<div class="row">
			<div class="col-3">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					<a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Agregar</a>
					<a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Ver Todos</a>
			...
			<div class="col-9">
				<div class="tab-content" id="v-pills-tabContent">
					<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
						...
						<div class="pd">
							<h3 class="primary-text title-m text-center">Registrar a un usuario</h3>
										...
										<form [formGroup]="form" (submit)="submit();">
											<div class="form-group">
													<div class="input-group mb-3">
															<div class="input-group-prepend">
															  <label class="input-group-text" for="type">Tipo de usuario</label>
															</div>
												...
												<div class="col-md-12">
													<div class="row">
														<div class="col-md-4">
															...
															<input type="email" class="form-control" placeholder="Correo" [(ngModel)]="user.email" formControlName="email" required="required">
															 
														</div>
														<div class="col-md-4">
															<label class="fs-b">Teléfono</label>
															<input type="text" class="form-control" placeholder="Teléfono" [(ngModel)]="user.cellphone" formControlName="cellphone" required="required">
														...
														<div class="col-md-4">
															...
															<div class="input-group">
																...
																<input id="initialDate" type="text" class="form-control" placeholder="Fecha Nacimiento" [(ngModel)]="user.birthday"
																 name="birthday" formControlName="birthday" autocomplete="off" data-date-format="yyyy-mm-dd" required="required">
															</div>
											...
											<div class="form-group">
												<div class="col-md-12">
													<div class="row">
														<div class="col-md-4">
															<label class="fs-b">Boleta/cedula</label>
															<input type="text" class="form-control" placeholder="Boleta/Cedula" [(ngModel)]="user.ticket" formControlName="ticket" required="required">
													...
													<div class="row">
														...
														<div class="col-md-4">
															...
															<select class="form-control" formControlName="colony" [(ngModel)]="user.address.colony.id" placeholder="-- Seleccione --">
																<option *ngFor="let item of colonies" value="{{ item.id }}"></option>
															</select>
					...
					<div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
						<!--Tabla para ver a todos los usuarios-->
						...
						<table class="table table-hover" id="usuarios">
							<thead>
								<tr>
									...
									<th scope="col">Tipo de Usuario
										<button type="button" (click)="ejecutar()" class="btn btn-primary" data-toggle="modal" data-target="#modificarUsuarioModal">
											Modificar
										</button>
		...
		<div class="modal fade" id="modificarUsuarioModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
						<!-- se tiene que mandar por get o post el usuario al archivo modificar-usuario-modal.html-->
				</div>
			</div>
		</div>
	</div>
