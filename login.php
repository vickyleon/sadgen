							...
							<div class="col-md-12">
								<div class="row">
									<div class="p.min col-md-6">
										<button type="button" class="btn btn-secondary btn-block" [routerLink]="['/recovery']">Recuperar contraseña</button>
									</div>
									<div class="p.min col-md-6">
										<button type="button" class="btn btn-secondary btn-block" [routerLink]="['/register']">Registrarme</button>
									</div>
								</div>
							</div>
						</form>
